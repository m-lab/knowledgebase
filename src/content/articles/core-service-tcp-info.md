...
TCP INFO data is parsed into BigQuery and available for free. See [Setting Up Free BigQuery Access](../getting-started-bigquery).
...
**Validating packet-level analysis** — TCP INFO statistics can be cross-referenced with [Packet Header captures](../core-service-packet-headers) to validate conclusions drawn from either dataset.
...
- [NDT — the test whose TCP connections TCP INFO instruments](../test-ndt)
- [Packet Headers — complementary packet-level data](../core-service-packet-headers)
- [MSAK — configurable throughput test also instrumented by TCP INFO](../test-msak)
